...
ENV JAVA_OPTS="-Xdebug -Xrunjdwp:server=y,transport=dt_socket,suspend=n,address=8000 -Djava.security.egd=file:/dev/./urandom -Dfile.encoding=UTF-8 -Xms150m -Xmx200m -XX:MaxMetaspaceSize=120m"
